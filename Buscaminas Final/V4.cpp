...
int main(){
    cout << "Luego de presionar Z el juego empezara terminando la musica\n";
    intro();
    //PlaySound que pertenece a la libreria Windowns
    PlaySound("C:\\Users\\lalala9813\\Desktop\\PracticandoAndo\\Buscaminas\\GS.wav",NULL,SND_FILENAME);//Para importar la musica de fondo del titulo
